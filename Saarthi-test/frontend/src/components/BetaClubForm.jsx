...
const BetaClubForm = ({ onClose, role }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await axios.post('http://localhost:8081/api/beta/join', {
                ...formData,
                role: role
            });
            setSuccess(true);
        ...
        return (
            <div className="modal-overlay">
                <div className="glass-panel" style={{ padding: '3rem', textAlign: 'center', maxWidth: '400px' }}>
                    ...
                    <p style={{ color: 'var(--text-muted)' }}>You've successfully joined the exclusive Beta Club. We'll be in touch soon.</p>
                </div>
            </div>
        );
    }
