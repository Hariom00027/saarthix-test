    ...
    <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        <div className="glass-panel" style={{ padding: '0.8rem 1.5rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <span style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>Total Interested:</span>
      ...
      {userRole === 'Student' && <StudentRoadmap />}
      {userRole === 'Institute' && <InstituteRoadmap />}
      {userRole === 'Industry' && <IndustryRoadmap />}
