...
public class Job {
    ...
    // HR Contact getters and setters
    public String getHrName() { return hrName; }
    public void setHrName(String hrName) { this.hrName = hrName; }

    public String getHrContactNumber() { return hrContactNumber; }
    public void setHrContactNumber(String hrContactNumber) { this.hrContactNumber = hrContactNumber; }

    public String getHrEmail() { return hrEmail; }
    public void setHrEmail(String hrEmail) { this.hrEmail = hrEmail; }

    public String getHrDesignation() { return hrDesignation; }
    public void setHrDesignation(String hrDesignation) { this.hrDesignation = hrDesignation; }
